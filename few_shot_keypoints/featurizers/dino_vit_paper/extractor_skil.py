"""
code copied from https://github.com/SKIL-robotics/SKIL/blob/main/diffusion_policy/common/extractor_dino.py

which copied it from https://github.com/ShirAmir/dino-vit-features/blob/main/extractor.py
and modified it to add dinov2 and AM-RADIO?
"""
...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vits8', stride: int = 4, model: nn.Module = None, device: str = 'cuda', model_local_dir=None):
        """
        ...
        if model is not None:
            ...
            self.model = ViTExtractor.create_model(model_type, model_local_dir=model_local_dir)
